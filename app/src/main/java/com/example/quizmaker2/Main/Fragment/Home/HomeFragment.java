...
public class HomeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable  Bundle savedInstanceState) {
        ...
        adapter=new HomeRecycleViewAdapter();
        ...
        search.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                List<Quiz> list=activity.getSql().getQuizByUsername(s.toString(),activity.getUser());
                adapter.setList(list);
                adapter.notifyDataSetChanged();
                System.out.println("Done"+s.toString());
            }
        });
        add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(activity,AddQuiz.class);
    ...
    public void Refresh(){
        ...
        Main activity=(Main)getActivity();
        List<Quiz> list=activity.getSql().getQuizByUser(activity.getUser());
        adapter.setList(list);
        adapter.notifyDataSetChanged();
    }
}